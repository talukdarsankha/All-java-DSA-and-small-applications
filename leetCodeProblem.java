...
//        int low = 0, high = row*column-1;               // because we assume that  we made it 1D Array
//        while (low<=high){
//            int mid=low+(high-low)/2;
//            int midEle=arr[mid/row][mid%row];
//            if (midEle==target){
//                return true;
...
//public class leetCodeProblem {
//
//    public static void possibleCombination(int n,int openBakettCount,int closeBaket,String ans){
//
//        if (n==openBakettCount&&n==closeBaket){
//            System.out.println(ans);
//            return;
//        }
//
//        if (openBakettCount<n) {
//            possibleCombination(n, openBakettCount + 1, closeBaket, ans + '(');
//        }
//        if (openBakettCount>closeBaket) {
//            possibleCombination(n, openBakettCount, closeBaket + 1, ans + ')');
//        }
//    }
//    public static void main(String[] args) {
//
//        possibleCombination(2,0,0," ");
//    }
//}
...
//               //    (Dice path) luddur chokka nuber porte pare at a time 1 or 2 or 3 or 4 or 5 or 6
//                  // Dice path  possiblePathToGoDestination from start
//
//
//public class leetCodeProblem {
//
//    public static void possiblePathToGoDestination(int start,int destination,String  path){
...
//            return;
//        }
//        possiblePathToGoDestination(start+1,destination,path+1);
//        possiblePathToGoDestination(start+2,destination,path+2);
//        possiblePathToGoDestination(start+3,destination,path+3);
//        possiblePathToGoDestination(start+4,destination,path+4);
//        possiblePathToGoDestination(start+5,destination,path+5);
//        possiblePathToGoDestination(start+6,destination,path+6);
//    }
//    public static void main(String[] args) {
//
//        possiblePathToGoDestination(0,9," ");
//
//
//    }
//}
...
//public class leetCodeProblem {
//
//    public static void   mazePath(int[][] arr , int row,int column ,String ss ){
...
//           return;
//       }
//        mazePath(arr,row+1,column,ss+"H");
//        mazePath(arr,row,column+1,ss+"V");
//    }
//    public static void main(String[] args) {
//
//        int[][] arr = {{0,0,0},
...
//                 // Tiles possible  combination
//            // n== tile number,  Tile size = 2*1 and bord where we set the tiles that size = 2*n;
//
//
//public class leetCodeProblem {
//
//    public static int tilesPossibleWay(int n){
////        if (n==1 || n==2 || n==3){
////            return n;
////        }
//        if (n<=3){
//            return n;
//        }
//        return tilesPossibleWay(n-1)+tilesPossibleWay(n-2);
//    }
//    public static void main(String[] args) {
//
//
...
//}
                         ...
                         //   All possible permutation of an array
...
//
//public class leetCodeProblem {
//    public static void permutation(int[] arr, List<List<Integer>> original_list ,List<Integer> temp){
//
...
//            }
//            temp.add(arr[i]);
//            permutation(arr,original_list,temp);
